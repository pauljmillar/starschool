...
angular.module('studentAssignmentDetailsCtrl', ['ui.bootstrap', 'ngMaterial'])

.controller('studentAssignmentDetailsCtrl',  function($scope, $http, services, $modal, $log, $routeParams, user, assignmentRecord, klassRecord, $mdDialog, $mdSidenav, $location) {
