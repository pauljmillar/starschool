...
angular.module('studentKlassAboutCtrl', ['ui.bootstrap'])

.controller('studentKlassAboutCtrl', function($routeParams, $scope, $http, services, $modal, $log, $timeout, $mdSidenav, $mdDialog,  klassRecord, user, $location) {
