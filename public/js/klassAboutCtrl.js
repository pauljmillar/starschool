...
angular.module('klassAboutCtrl', ['ui.bootstrap'])

.controller('klassAboutCtrl', function($routeParams, $scope, $http, services, $modal, $log, $timeout, $mdSidenav, $mdDialog,  klassRecord, user, $location) {
	...
	$scope.setEditMode = function() {
		...
		services.updateKlass($scope.thisKlass)
