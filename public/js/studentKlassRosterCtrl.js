...
angular.module('studentKlassRosterCtrl', ['ui.bootstrap'])

.controller('studentKlassRosterCtrl', function($routeParams, $scope, $http, services, $modal, $log, $timeout, $mdSidenav, $mdDialog, studentList, klassRecord, user, $location) {
