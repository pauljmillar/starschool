...
angular.module('assignmentsCtrl', ['ui.bootstrap', 'ngMaterial'])

.controller('assignmentsCtrl',  function($scope, $http, services, $modal, $log, $routeParams, assignmentList, $mdDialog, $mdSidenav, $location) {
...
//for side nav menu	
	...
	$scope.classView = function(id){
        $location.path('/class/'+id); // path not hash
  };	
